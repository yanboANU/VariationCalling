...
if [ ! -f "chr$1_k$2.txt" ]; then 
	...
	/home/yulin/software/dsk/build/bin/dsk -nb-cores 10 -file $5 -histo 1 -out chr$1_k$3 -kmer-size $3
	/home/yulin/software/dsk/build/bin/dsk2ascii -nb-cores 10 -file chr$1_k$3 -out chr$1_k$3.txt
fi
...
python /home/yulin/bio/VariationCalling/variationCalling.py --t1 chr$1_k$2.txt --t2 chr$1_k$3.txt --c1 $left --c2 $right --k $2 --b $6 >vc_k$2.log 
